  ...
  const telegramFeatures = {
    members: [
      ...
      },
      {
        ...
        description: 'הסרת חברים לא פעילים מהקבוצה',
        min: 10,
        max: 5000,
        details: 'הסרה אוטומטית של חברים שלא פעילים',
        icon: '🧹',
        parameters: {
          url: { label: 'קבוצה/ערוץ לניקוי', required: true },
          inactivityDays: { label: 'ימים ללא פעילות', required: true, type: 'number', min: 7, max: 365 },
          action: { label: 'פעולה', required: true, type: 'select', options: ['הסרה', 'חסימה', 'התראה למנהל'] },
          backupList: { label: 'שמירת רשימה', required: true, type: 'select', options: ['כן', 'לא'] }
        }
      },
      {
        id: 'member_reactivation',
        name: 'הפעלת חברים רדומים',
        description: 'שליחת הודעות לחברים רדומים להפעלה',
        min: 50,
        max: 10000,
        details: 'שליחת הודעות מותאמות לחברים לא פעילים',
        icon: '💤',
        parameters: {
          url: { label: 'קבוצה/ערוץ', required: true },
          message: { label: 'תוכן ההודעה', required: true, type: 'textarea' },
          inactivityDays: { label: 'ימים ללא פעילות', required: true, type: 'number', min: 7, max: 90 },
    ...
    targeting: [
      ...
      },
      {
        ...
        name: 'ניתוח מתחרים',
        description: 'ניתוח קבוצות וערוצים של מתחרים',
        min: 1,
        max: 50,
        details: 'ניתוח מפורט של מתחרים וקבוצותיהם',
        icon: '🔍',
        parameters: {
          competitorUrls: { label: 'רשימת מתחרים', required: true, type: 'textarea' },
          analysisType: { label: 'סוג ניתוח', required: true, type: 'multiselect', options: ['חברים', 'אקטיביות', 'תוכן', 'זמני פרסום', 'האשטגים'] },
          reportFormat: { label: 'פורמט דוח', required: true, type: 'select', options: ['PDF', 'Excel', 'CSV'] },
      ...
      },
      {
        id: 'hashtag_research',
        name: 'מחקר האשטגים',
        description: 'מחקר האשטגים פופולריים בתחום',
        min: 1,
        max: 100,
        details: 'מחקר האשטגים הכי פופולריים ויעילים',
        icon: '#️⃣',
        parameters: {
          keywords: { label: 'מילות מפתח', required: true, type: 'textarea' },
          language: { label: 'שפה', required: true, type: 'select', options: ['עברית', 'אנגלית', 'ערבית', 'כל השפות'] },
          timeRange: { label: 'טווח זמן', required: true, type: 'select', options: ['שבוע', 'חודש', '3 חודשים', 'שנה'] },
          minUsage: { label: 'שימוש מינימלי', required: true, type: 'number', min: 10, max: 10000 }
        }
      }
    ],
    groups: [
      ...
      },
      {
        ...
        description: 'הוספת סטארים לבוטים (העלאת דירוג)',
        min: 1,
        max: 1000,
        details: 'הוספת סטארים לבוטים להעלאת דירוג ואיכות',
        icon: '⭐',
        parameters: {
          botUrl: { label: 'URL הבוט', required: true, type: 'text' },
          starsQuantity: { label: 'כמות סטארים', required: true, type: 'number', min: 1, max: 1000 },
          starType: { label: 'סוג סטארים', required: true, type: 'select', options: ['סטארים רגילים', 'סטארים פרמיום', 'סטארים VIP'] },
          duration: { label: 'משך הפעולה (ימים)', required: true, type: 'number', min: 1, max: 30 },
          targetAudience: { label: 'קהל יעד', required: true, type: 'select', options: ['כל העולם', 'ישראל', 'ארה"ב', 'אירופה', 'אסיה'] },
          delay: { label: 'עיכוב בין הוספות (שניות)', required: true, type: 'number', min: 1, max: 300 }
        }
      }
    ],
    automation: [
      ...
      {
        id: 'auto_welcome',
        name: 'הודעות ברכה אוטומטיות',
        description: 'שליחת הודעות ברכה לחברים חדשים',
        min: 1,
        max: 1,
        details: 'הודעות ברכה מותאמות אישית לחברים חדשים',
        icon: '👋',
        parameters: {
          url: { label: 'קבוצה/ערוץ', required: true },
          welcomeMessage: { label: 'הודעת ברכה', required: true, type: 'textarea' },
          includeRules: { label: 'כלול חוקים', required: true, type: 'select', options: ['כן', 'לא'] },
          delay: { label: 'עיכוב (שניות)', required: true, type: 'number', min: 1, max: 60 }
        }
      },
      {
        id: 'auto_backup',
        name: 'גיבוי אוטומטי',
        description: 'גיבוי אוטומטי של הודעות וחברים',
        min: 1,
        max: 1,
        details: 'גיבוי יומי/שבועי של כל הנתונים',
        icon: '💾',
        parameters: {
          url: { label: 'קבוצה/ערוץ', required: true },
          backupType: { label: 'סוג גיבוי', required: true, type: 'multiselect', options: ['הודעות', 'חברים', 'קבצים', 'הגדרות'] },
          frequency: { label: 'תדירות', required: true, type: 'select', options: ['יומי', 'שבועי', 'חודשי'] },
          storage: { label: 'אחסון', required: true, type: 'select', options: ['מקומי', 'ענן', 'שניהם'] }
        }
      },
      {
        id: 'auto_analytics',
        name: 'דוחות אוטומטיים',
        description: 'יצירת דוחות סטטיסטיקה אוטומטיים',
        min: 1,
        max: 1,
        details: 'דוחות יומיים/שבועיים על ביצועי הקבוצה',
        icon: '📊',
        parameters: {
          url: { label: 'קבוצה/ערוץ', required: true },
          reportType: { label: 'סוג דוח', required: true, type: 'multiselect', options: ['חברים', 'הודעות', 'אקטיביות', 'קבצים'] },
          frequency: { label: 'תדירות', required: true, type: 'select', options: ['יומי', 'שבועי', 'חודשי'] },
          recipients: { label: 'נמענים', required: true, type: 'textarea' }
        }
      }
    ],
    views: [
      ...
      },
      {
        ...
        description: 'הוספת צפיות לשידורים חיים',
        min: 100,
        max: 50000,
        details: 'צפיות איכותיות בשידורים חיים',
        icon: '📺',
        parameters: {
          streamUrl: { label: 'URL השידור', required: true },
          viewsQuantity: { label: 'כמות צפיות', min: 100, max: 50000, required: true },
          duration: { label: 'משך הצפייה (דקות)', required: true, type: 'number', min: 1, max: 60 },
          quality: { label: 'איכות צפייה', required: true, type: 'select', options: ['נמוכה', 'בינונית', 'גבוהה'] }
        }
      },
      {
        id: 'voice_message_views',
        name: 'האזנה להודעות קוליות',
        description: 'הוספת האזנות להודעות קוליות',
        min: 50,
        max: 10000,
        details: 'האזנה איכותית להודעות קוליות',
        icon: '🎧',
        parameters: {
          messageUrl: { label: 'URL ההודעה הקולית', required: true },
          listensQuantity: { label: 'כמות האזנות', min: 50, max: 10000, required: true },
          listenDuration: { label: 'משך האזנה (%)', required: true, type: 'number', min: 10, max: 100 }
        }
      }
    ],
    advanced: [
              ...
              <select
                value={selectedFeature}
                 onChange={(e) => {
                   ...
                   setDynamicParams({}); // איפוס הפרמטרים כשמשנים פיצ'ר
                 }}
                style={{
                  width: '100%',
                  padding: '12px',
                 ...
                 {Object.entries(selectedFeatureData.parameters).map(([key, param]: [string, any]) => (
                   <div key={key} style={{ marginBottom: '20px' }}>
                     ...
                     {param.type === 'select' ? (
                       ...
                       >
                         <option value="">בחר {param.label.toLowerCase()}...</option>
